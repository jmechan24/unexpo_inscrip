...
CREATE TABLE `academic_period_courses` (
  ...
  PRIMARY KEY (`id`),
  KEY `id_academic_period` (`id_period`),
  KEY `id_courses` (`id_courses`),
  KEY `academic_period_courses_teacher_id_fk` (`id_teacher`),
  KEY `academic_period_courses_classroom_id_fk` (`id_classroom`),
  CONSTRAINT `academic_period_courses_classroom_id_fk` FOREIGN KEY (`id_classroom`) REFERENCES `classroom` (`id`),
  CONSTRAINT `academic_period_courses_ibfk_1` FOREIGN KEY (`id_period`) REFERENCES `academic_period` (`id`),
  CONSTRAINT `academic_period_courses_ibfk_2` FOREIGN KEY (`id_courses`) REFERENCES `courses` (`id`),
  CONSTRAINT `academic_period_courses_teacher_id_fk` FOREIGN KEY (`id_teacher`) REFERENCES `teacher` (`id`)
...
-- Dump completed on 2023-08-08  8:04:41
